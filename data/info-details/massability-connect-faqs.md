---
source_url: https://www.mass.gov/info-details/massability-connect-faqs
title: MassAbility Connect FAQs | Mass.gov
fetched_at: 2026-05-18T00:56:20.670Z
---

# MassAbility Connect FAQs

Frequently Asked Questions about MassAbility Connect
...
[Skip table of contents](https://www.mass.gov/info-details/massability-connect-faqs#ma-end-sticky-toc)
...
## What is MassAbility Connect?

MassAbility Connect collects your referral information in one place and helps the agency identify programs and services you may be eligible for. Below are the programs included in the application.
...
- Require career services to train, find or keep a job

Examples of Career Services

- Career counseling, guidance, and assistance in job placement, such as interview preparation, job coach, and/or direct job placement services
- Training programs including job-driven partnerships with employers, college and career certificate programs
- Assistive technology and rehabilitation technology services

## **Services for Students & Youth**

MassAbility offers support around job preparation and exploration for students 14 and older while they are still in high school. MassAbility works with many community providers to offer pre-employment transition services for students.
...
- Skills Training: Helping partcipants learn the skills they need to live in the community
...
The application can be found at [MassAbility Connect Online Application](https://massmrc.hylandcloud.com/customcode/mrconemrc)

## What is the process for applying to a program?

- The initial step in applying is to submit an online application. To start your application, visit [www.mass.gov/info-details/apply-for-services](https://www.mass.gov/info-details/apply-for-services) and click on "apply for services," or call our information and referral line at 617-204-3665.
...
- Depending on the program you're applying for, additional documentation may be required before determining eligibility. The MassAbility Connect team member will guide you through this when they reach out
- You'll then undergo an initial interview, this can be conducted over the phone, via zoom, or in person with an eligibility screener. It can also be completed using our online assisted intake form. The interview can be done promptly when a MassAbility Connect team member reaches out or is scheduled for a future date.
...
No. The online application is an additional avenue to apply for MassAbility services and programs.
...
Yes. If you have appropriate documentation at the time of filling out the application, they can upload digital documents to the online application. If not, MassAbility staff will be following up with each applicant to obtain the appropriate documentation.
...
No, the online application does not assess eligibility. It serves as a referral and is designed to comprehend your needs. This enables MassAbility to share information across potential programs, streamlining the process so that you only need to provide the information once.
...
[Feedback](https://www.mass.gov/info-details/massability-connect-faqs#feedback)
