---
source_url: https://www.mass.gov/info-details/determine-disability-benefits
title: Determine Disability Benefits | Mass.gov
fetched_at: 2026-06-17T18:46:46.198Z
---

# Determine Disability Benefits

If your ability to work is limited, MassAbility is committed to ensuring you get the disability benefits you need to live on your own terms.

With MassAbility Disability Determination Services (DDS), you can find out if you are eligible for Social Security Disability Insurance (SSDI) and Supplemental Security Income (SSI) benefits.

[Skip table of contents](https://www.mass.gov/info-details/determine-disability-benefits#ma-end-sticky-toc)
...
[Apply for Benefits](https://www.ssa.gov/) [Application Process](https://www.mass.gov/info-details/how-applications-for-disability-benefits-are-processed)
...
- employed,
- have earned the required amount of hourly-based work credits, _and_
...
To learn more about your eligibility for SSDI and SSI, [visit the Social Security Disability information page](https://www.ssa.gov/benefits/disability/). You can also determine your eligibility for SSDI and SSI by using the [SSA’s Benefit Eligibility Screening Tool here](https://www.ssa.gov/prepare/check-eligibility-for-benefits).
...
[Apply for Benefits](https://www.ssa.gov/) [File a Claim](https://www.mass.gov/info-details/how-to-file-a-claim-for-ssdi-or-ssi)
...
617-727-1600 or 1-800-882-2040 (Boston toll-free)

### **DDS Office Worcester**

508-752-5001 or 1-800-551-5532 (Worcester toll-free)
...
| Special Initiatives at DDS | Special Initiatives at DDS Contd. |
| --- | --- |
| **Health Information Technology (HIT)**<br>Health Information Technology (HIT) stores and manages your health and medical records in a secure manner. Disability Determination Services (DDS) uses HIT to collect, evaluate and share information with multiple parties, and make decisions faster. | **Quick Disability Determination (QDD)**<br>Quick Disability Determination (QQD) is a computer-based system that screens claims applications and identifies cases which will take a short amount of time to be determined. By separating these types of cases from more time-consuming ones, QDD speeds up eligibility decisions for all applicants. |
| **Compassionate Allowances (CAL)**<br>Created by the Social Security Administration (SSA), the Compassionate Allowances (CAL) initiative speeds up disability claim decisions for individuals who have certain health and medical conditions, including cancers and adult brain disorders. | **Military Casualty/Wounded Warrior (MC/WW)**<br>The Military Casualty/Wounded Warrior (MC/WW) Program helps speed up disability claims filed by military veterans. To be eligible for MC/WW, veterans must: be injured on or after October 1, 2001, and on active duty at time of the injury. |
...
[Feedback](https://www.mass.gov/info-details/determine-disability-benefits#feedback)
